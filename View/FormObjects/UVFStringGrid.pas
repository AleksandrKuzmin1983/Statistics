...
type
  IStringGridTag5 = interface
    function GetStringGrid(Cleft, Сtop, CWidth, CHeight, CColCount, CRowCount, FontSize: integer; CurrentForm: TForm): TStringGrid;
...
begin
  ...
  if (ACol <> Col1) and (ACol <> Col2) and (ACol <> Col3) and (ACol <> Col4) and (ACol <> Col5) then Format := DT_LEFT; // второй столбец – положение текста по левому краю
...
function TStringGridTag5.GetStringGrid(Cleft, Сtop, CWidth, CHeight, CColCount, CRowCount, FontSize: integer; CurrentForm: TForm): TStringGrid;
begin
