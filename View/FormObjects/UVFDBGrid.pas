...
procedure TGridDB.PostValue;
begin
  TempDBGrid.DataSource.DataSet.Post;
end;
...
procedure TGridDB.Visible(NumberCol: integer; i: Boolean);
begin
...
procedure TGridDB.WriteValue(NumberField: integer; Value: Variant);
begin
  TempDBGrid.DataSource.DataSet.Fields[NumberField].Value:=Value;
end;

procedure TGridDB.EditValue;
begin
...
function TGridDB.GetValue(NumberField: integer): Variant;
begin
