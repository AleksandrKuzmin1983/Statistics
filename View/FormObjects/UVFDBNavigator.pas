...
type
  INavigatorDB = interface
    function GetGridDB(Cleft, Ñtop, FontSize: integer; CurrentForm: TForm): TDBNavigator;
  end;
...
function TNavigatorDB.GetGridDB(Cleft, Ñtop, FontSize: integer; CurrentForm: TForm): TDBNavigator;
begin
