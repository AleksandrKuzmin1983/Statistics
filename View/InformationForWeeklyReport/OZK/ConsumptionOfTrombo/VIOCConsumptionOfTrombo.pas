...
type
  ...
  TVIOCConsumptionOfTrombo = class(TInterfacedObject, IVIOCConsumptionOfTrombo)
  private
    LabelCancellationDate: ITempLabelTag5;
    LabelTheNameOfTrombo: ITempLabelTag5;
...
begin
  ...
  result := ReasonConsumption.GetComboBox(285, 280, 300, 14, NameForm);
