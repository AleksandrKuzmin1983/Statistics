...
uses
  ...
  MRWIncompleteWeekFirstTable,
  MRWTableForDefectIncompleteWeek,
  MRWLPUConsultationIncompleteWeek,
  MRWResultsOfTheProductsIncompleteWeek,
  MRWResultsOfTheProductsIncompleteWeek2,
  MRWDonorsAndProceduresIncompleteWeek,
  MRWDonorsAndProceduresIncompleteWeekOuting,
  MRWMedicalExemptionsIncompleteWeek,
  MRWCancellation_KrayIncomlpeteWeek,
  MRWSecondTableIncompleteWeek,
  UVFMainMenu,
  UMSGlobalVariant;
...
begin
  ...
  frxTempReport.LoadFromFile(CurrentDir + '\Model\Reports\WeeklyIncompleteWeek\IncompleteWeek.fr3');
