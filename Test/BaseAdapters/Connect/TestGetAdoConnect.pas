...
uses
  TestFramework, Dialogs, GetAdoConnect, SysUtils, Data.Win.ADODB;
...
begin
  i:=0;
  CurrentDir:=ExtractFileDir(ExtractFilePath(ExtractFileDir(ExtractFilePath(ExtractFileDir(ExtractFileDir(ParamStr(0)))))));
  if FileExists(CurrentDir + '\BaseAdapters\Connect\ConnectingStringx64.udl') then i:=1;
  ...
  CheckEquals(ReturnValue.ConnectionString, CurrentDir + '\BaseAdapters\Connect\ConnectingStringx64.udl', 'ADOConection не создан!');
end;
