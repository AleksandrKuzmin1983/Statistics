...
begin
  ...
  CodeSite.Send(FormatDateTime('c', Now) + ' TBQBTheNumberOfConservedBlood.create выполнена');
end;
...
begin
  ...
  CodeSite.Send(FormatDateTime('c', Now) + ' TBQBTheNumberOfConservedBlood.GetValue выполнена');
end;
