...
begin
  ...
  CodeSite.Send(FormatDateTime('c', Now) + ' TBQPHarvestingOfTromboDosesTotal.create выполнена');
end;
...
begin
  ...
  CodeSite.Send(FormatDateTime('c', Now) + ' TBQPHarvestingOfTromboDosesTotal.GetValue выполнена');
end;
