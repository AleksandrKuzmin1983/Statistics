...
begin
  ...
  CodeSite.Send(FormatDateTime('c', Now) + ' TBQPHarvestingOfTromboPacetsTotal.create выполнена');
end;
...
begin
  ...
  CodeSite.Send(FormatDateTime('c', Now) + ' TBQPHarvestingOfTromboPacetsTotal.GetValue выполнена');
end;
