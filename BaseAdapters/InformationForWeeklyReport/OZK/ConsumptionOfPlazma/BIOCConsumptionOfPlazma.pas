...
type
  IBIOCConsumptionOfPlazma = interface
  ...
  TBIOCConsumptionOfPlazma = class(TInterfacedObject, IBIOCConsumptionOfPlazma)
  private
    SQL: String;
...
procedure TBIOCConsumptionOfPlazma.GetContent;
var
  i: integer;
begin
...
function TBIOCConsumptionOfPlazma.GetCancellationDate(i: integer): string;
begin
  result := ResultMass[i].CancellationDate;
end;

function TBIOCConsumptionOfPlazma.GetRowCount: integer;
begin
  result := Length(ResultMass);
end;

function TBIOCConsumptionOfPlazma.GetNumberOfDoses(i: integer): string;
begin
  result := ResultMass[i].NumberOfDoses;
end;

function TBIOCConsumptionOfPlazma.GetReasonConsumption(i: integer): string;
begin
  result := ResultMass[i].ReasonConsumption;
end;

function TBIOCConsumptionOfPlazma.GetTheNameOfTheEnvironment
  (i: integer): string;
begin
  result := ResultMass[i].TheNameOfPlazma;
end;

function TBIOCConsumptionOfPlazma.GetVolume(i: integer): string;
begin
  result := ResultMass[i].Volume;
end;

function TBIOCConsumptionOfPlazma.GetKod(i: integer): string;
begin
