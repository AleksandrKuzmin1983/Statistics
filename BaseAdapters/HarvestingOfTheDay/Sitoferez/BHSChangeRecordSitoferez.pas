  ...
  Try
    ...
    begin
      ...
      SQL.Add('UPDATE Tromb SET ' +
        'Tromb.КДТ=' + VolumeDonors + ', ' +
        'Tromb.НаКонТ=' + SentToPreserving + ', ' +
        'Tromb.ЛабТ=' + ForLaboratoryResearch + ', ' +
        'Tromb.ЦелТ=' + AllWholeBlood + ', ' +
        'Tromb.КонТ=' + AllStoredBlood + ' ' +
        'WHERE Tromb.ДатаТ=#' + FormatDateTime('mm''/''dd''/''yyyy', dateOf(Date)) + '# ');
      ExecSQL;
    end;
  except
  ...
  Try
    ...
    begin
      ...
      SQL.Add('UPDATE TrombDoza SET ' +
        'TrombDoza.ДозаТ=' + Value + ' ' +
        'WHERE TrombDoza.ДатаТ=#' + FormatDateTime('mm''/''dd''/''yyyy', dateOf(Date)) + '# ');
      ExecSQL;
    end;
  except
  On e : EDatabaseError do
  ...
  Try
    ...
    begin
      ...
      SQL.Add('UPDATE TrombComponents SET ' +
        'TrombComponents.КПЛТ=' + VolumeTrombo + ', ' +
        'TrombComponents.ПакТ=' + NumberOfPacketsTrombo + ', ' +
  ...
  Try
    ...
    begin
      ...
      SQL.Add('UPDATE TrombBrak SET ' +
        'TrombBrak.КБРТ=' + VolumeDefects + ', ' +
        'TrombBrak.КПБТ=' + NumberOfPacketsDefects  + ', ' +
        'TrombBrak.ДБРТ=' + NumberDosesDefects  + ', ' +
        'TrombBrak.ВидБРТ=''' + TypeOfDefect + ''' ' +
