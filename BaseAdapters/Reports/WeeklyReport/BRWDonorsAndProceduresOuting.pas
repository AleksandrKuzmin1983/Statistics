...
begin
  ...
  CodeSite.Send(FormatDateTime('c', Now) + ' TBRWDonorsAndProceduresOuting.create выполнена');
end;
...
begin
  ...
  CodeSite.Send(FormatDateTime('c', Now) + ' TBRWDonorsAndProceduresOuting.GetValue выполнена', result);
end;
