...
type
  ...
  IBRWReasonsForMedicalExemptions = interface
    function GetValueName(i: Integer): string;
    function GetValueNumber(i: Integer): string;
    function GetValueOuting(i: Integer): string;
  end;

  TBRWReasonsForMedicalExemptions = class(TInterfacedObject,
    IBRWReasonsForMedicalExemptions)
  private
...
constructor TBRWReasonsForMedicalExemptions.create;
var
  i, j: Integer;
begin
  ...
  CSQL := 'SELECT Taps.NameTap ' +
    ...
    + 'ORDER BY TypesOfTaps.Id, Taps. од;';
  Try
    With TempQuery do
    begin
      Close;
