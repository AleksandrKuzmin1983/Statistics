...
type
  IBRWTableForDefectIncompleteWeek = interface
  ...
  TBRWTableForDefectIncompleteWeek = class(TInterfacedObject,
    IBRWTableForDefectIncompleteWeek)
  private
    SQL: String;
...
procedure TBRWTableForDefectIncompleteWeek.destroy;
begin
  TempConnect.destroy;
  TempConnect := nil;
