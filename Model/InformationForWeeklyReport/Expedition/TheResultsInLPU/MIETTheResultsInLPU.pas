...
begin
  ...
  TempQuery.Close;
  TempQuery.SQL.Clear;
  SQL:='SELECT Exped. Ó‰, Exped.ƒ¿“¿À«, Exped.Õ—, TypeOfLPUandOther.NameRecord, ' +
  'Exped.À«Œ, Exped.À«ƒ, Exped.À«œ–, Exped.À«œ¿  ' +
  'FROM TypeOfLPUandOther INNER JOIN Exped ON TypeOfLPUandOther.NameRecord = Exped.¬À« ' +
  'WHERE (((Exped.À«ƒ)>=0) AND ((TypeOfLPUandOther.TypeLPU)=True)) ' +
