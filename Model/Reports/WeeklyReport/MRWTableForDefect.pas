...
type
  ...
  TMRWTableForDefect = class(TInterfacedObject,
    IMRWTableForDefect)
  private
    SQL: String;
...
procedure TMRWTableForDefect.destroy;
begin
  TempConnect.destroy;
  TempConnect:=nil;
...
procedure TMRWTableForDefect.GetContent;
var i: integer;
begin
...
function TMRWTableForDefect.GetTypeOfDefect(i: integer): string;
begin
  result := ResultMass[i].TypeOfDefect;
end;

function TMRWTableForDefect.GetRowCount: integer;
begin
  result:=Length(ResultMass);
end;

function TMRWTableForDefect.GetVolume(i: integer): string;
begin
  result := ResultMass[i].Volume;
end;

function TMRWTableForDefect.GetTypeOfProduct(i: integer): string;
begin
