unit MRWReasonsForMedicalExemptions;
...
type
  ...
  IMRWReasonsForMedicalExemptions = interface
    function GetValueName(i: integer): string;
    function GetValueNumber(i: integer): string;
    function GetValueOuting(i: integer): string;
  end;

  TMRWReasonsForMedicalExemptions = class(TInterfacedObject, IMRWReasonsForMedicalExemptions)
  private
...
constructor TMRWReasonsForMedicalExemptions.create;
var
  i,j: integer;
begin
...
function TMRWReasonsForMedicalExemptions.GetValueNumber(i: integer): string;
begin
  result:=IntToStr(TempArray[i].number);
end;

function TMRWReasonsForMedicalExemptions.GetValueName(i: integer): string;
begin
  result:=TempArray[i].name;
end;

function TMRWReasonsForMedicalExemptions.GetValueOuting(i: integer): string;
begin
