unit MRWDonorsAndProceduresOuting;
...
uses
  ...
  UCheckNull;
type
  IMRWDonorsAndProceduresOuting = interface
    function GetValue(i: integer): string;
  end;

  TMRWDonorsAndProceduresOuting = class(TInterfacedObject, IMRWDonorsAndProceduresOuting)
  private
...
constructor TMRWDonorsAndProceduresOuting.create;
var
  i: integer;
begin
...
function TMRWDonorsAndProceduresOuting.GetValue(i: integer): string;
begin
