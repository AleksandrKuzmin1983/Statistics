...
begin
  ...
  frxTempReport.LoadFromFile(CurrentDir + '\BaseAdapters\Reports\DailyReportToTheKray\DailyReportToTheKray.fr3');
...
begin
  ...
  frxTepmExportPDF.FileName:='Ежедневный отчет по крови за ' + DateToStr(date()) + '. Лесосибирский филиал.pdf';
